...
export default function FlingExample() {
    ...
    const animatedStyles = useAnimatedStyle(() => {
        const backgroundColor = interpolateColor(colorProgress.value, [0, 1], [color1.value, color2.value]);
    ...
    return (
        <View className="flex-1 justify-around items-center">
            <GestureDetector gesture={g}>
                <Animated.View className="size-24 rounded-3xl" style={animatedStyles} />
            </GestureDetector>
        </View>
    );
}
